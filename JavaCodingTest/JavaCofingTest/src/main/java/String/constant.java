...
public class constant {
    ...
    *  */
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(Integer.valueOf(String.valueOf(A)) < Integer.valueOf(String.valueOf(B))) {
            bw.write(Integer.valueOf(String.valueOf(B)) + "");
        }else {
            bw.write(Integer.valueOf(String.valueOf(A)) + "");
        }
        bw.flush();
        bw.close();
    }
